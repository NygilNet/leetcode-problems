"""
link to problem: https://leetcode.com/problems/evaluate-division/description/
...
INPUT: equations (array of arrays with two strings), values (array of floats), queries (array of arrays with two strings)
OUTPUT: array of floats (the final solution of each query)

problem 1 - solve for variables:
